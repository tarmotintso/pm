...
function Seat() {
    ...
    this.initialize = function (o) {
        ...
        if (o.state == "notavailable")this.makeDeactive(); else if (o.state == "active")this.makeActive(); else if (o.state == "available")this.makeNormal();
...
$(document).ready(function () {
    ...
    function checkWidth() {
        ...
        if (last_mobile_width == windowsize)return;
    ...
    $("#osta-kohe-vorm").submit(function (e) {
        ...
        jQuery.ajax({type: "POST", url: $(this).attr("action"), data: $(this).serialize(), success: function (response) {
            if (response.success)
                window.location.href = response.redirect; else {
                var errors = false;
